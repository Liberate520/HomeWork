...
//    Посмотрел проект на нарушение принципов SOLID явных нарушений не нашел
//    проект может быть масштабирован с помощью расширения возможностей классов, а не их модификации.
}
