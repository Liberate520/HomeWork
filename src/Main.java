...
//                objectOutputStream.writeObject(hum1);
//                objectOutputStream.writeObject(hum2);
//                objectOutputStream.writeObject(hum3);
//                objectOutputStream.writeObject(hum4);
//                objectOutputStream.writeObject(hum5);
//                objectOutputStream.writeObject(hum6);
                objectOutputStream.close();
            }

            @Override
            public void restore() throws ClassCastException, IOException, ClassNotFoundException {
                ObjectInputStream objectInputStream = new ObjectInputStream(
                        new FileInputStream("person.out"));
                Human hum1 = (Human) objectInputStream.readObject();

                Human hum2 = (Human) objectInputStream.readObject();
                Human hum3 = (Human) objectInputStream.readObject();
                Human hum4 = (Human) objectInputStream.readObject();
                Human hum5 = (Human) objectInputStream.readObject();
                Human hum6 = (Human) objectInputStream.readObject();
                ft.addHuman(hum1);
                ft.addHuman(hum2);
                ft.addHuman(hum3);
                ft.addHuman(hum4);
