...
public class Main {
    ...
    private static FamilyTree testTree() {
        ...
        Human ruslan = new Human("Руслан", Gender.Male, LocalDate.of(1976, 11, 8), LocalDate.of(2017, 6, 7));
        ...
        Human liza = new Human("Лиза", Gender.Female, LocalDate.of(1998, 8, 19), ruslan, elena);
        Human nasty = new Human("Настя", Gender.Female, LocalDate.of(2002, 7, 11), ruslan, elena);
