...
//        System.out.println(familyTree.count());
//        System.out.println(dima.getGrandParents());
//        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd.MM.yyyy");
//        saveTree(familyTree, filePath);
//        System.out.println(Period.between(LocalDate.of(2023, 10, 27), LocalDate.of(2024, 4, 4)).getDays());
