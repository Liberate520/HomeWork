...
public class Main {
    public static void main(String[] args) throws FileNotFoundException, IOException, ClassNotFoundException {
        ...
        // service.addNewParent(member11, member7);
        // service.addNewParent(member11, member5);
        // service.addNewParent(member8, member3);
        // service.addNewParent(member8, member6);
        // service.addNewParent(member9, member3);
        // service.addNewParent(member9, member6);
        // service.addNewParent(member10, member3);
        // service.addNewParent(member10, member6);        
