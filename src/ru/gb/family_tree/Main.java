...
public class Main {
    public static void main(String[] args) {
        ...
        Human human4 = new Human("Вареникова Светлана Петровна", LocalDate.of(1994, 2, 18), Gender.Female, human1, human3);
        Human human5 = new Human("Скворцова Ульяна Семёновна", LocalDate.of(1985, 9, 2), Gender.Female, null, null);
