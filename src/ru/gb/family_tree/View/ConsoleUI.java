...
public class ConsoleUI implements View {
    ...
    public void createData() {
        Human person = presenter.addItem("Григорий",null,"Рыжков",LocalDate.parse("1920-12-05"),
                null,null,null,null);

        presenter.addItem("Семен","Григорьевич","Рыжков",
                LocalDate.parse("1960-01-23"),LocalDate.parse("2000-05-23"),Gender.Male,person,null);

        person = presenter.addItem("Федор","Григорьевич","Рыжков",
                null,null,null,person,null);

        person = presenter.addItem("Ирина","Семеновна","Рыжкова",LocalDate.parse("1988-08-15"),null,
