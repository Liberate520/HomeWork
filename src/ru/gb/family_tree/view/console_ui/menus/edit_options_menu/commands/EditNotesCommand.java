...
public class EditNotesCommand extends Command {
    private int id;
    private final CollectorItems editedItem = CollectorItems.Notes;
    public EditNotesCommand(ConsoleUi consoleUi, int id) {
        super("Редактировать заметки", consoleUi);
        this.id = id;
    }
    ...
    private String inputNewValue(){
        return getConsoleUi().inputParam("новые заметки");
    }
}
