...
public class MainMenu {
    ...
    public MainMenu(ConsoleUI consoleUI) {
        ...
        listCommand.add(new FileUpload(consoleUI));
        listCommand.add(new SavingToFile(consoleUI));
    ...
    public void execut(String inputUser) throws FileNotFoundException, IOException, ClassNotFoundException {
