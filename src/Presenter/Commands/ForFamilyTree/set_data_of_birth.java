...
public class set_data_of_birth extends Command implements Performing {
    private final Tree familyTree;
    private final View view;

    public set_data_of_birth(View view, Tree familyTree){
        super("set data of birth", "Изменить дату рождения");
