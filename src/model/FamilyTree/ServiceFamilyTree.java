...
import model.FileHandler.Writer;
...
public class ServiceFamilyTree {
    ...
    public void addHuman(String lastName, String firstname, String patronymic, Gender gender, LocalDate dayBirth, LocalDate dayDeath, String placeBorn) {
    }
}
